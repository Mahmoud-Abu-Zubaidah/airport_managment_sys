...
<report name="RE_AIRPORT_LINES" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL AIRPORT_LINES.FLIGHT_NUMBER, 
AIRPORT_LINES.FIRST_CLASS, AIRPORT_LINES.BUSINESS_CLASS, 
AIRPORT_LINES.ECONOMY_CLASS, AIRPORT_LINES.DISTANCE, AIRPORT_LINES.ARRIVED_TIME, 
AIRPORT_LINES.FLY_TIME, AIRPORT_LINES.STATUS_CODE, AIRPORT_LINES.PLANE_CODE, 
AIRPORT_LINES.FROM_AIRPORT_ID, AIRPORT_LINES.TO_AIRPORT_ID
FROM AIRPORT_LINES ]]>
      </select>
      ...
      <group name="G_FLIGHT_NUMBER">
        ...
        <dataItem name="FLIGHT_NUMBER" oracleDatatype="number"
         columnOrder="11" width="22" defaultWidth="120000"
         defaultHeight="10000" columnFlags="33" defaultLabel="Flight Number">
          <dataDescriptor expression="AIRPORT_LINES.FLIGHT_NUMBER"
           descriptiveExpression="FLIGHT_NUMBER" order="1" width="22"
           precision="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="FIRST_CLASS" oracleDatatype="number" columnOrder="12"
        ...
        <dataItem name="DISTANCE" datatype="vchar2" columnOrder="15"
         ...
         columnFlags="33" defaultLabel="Distance">
          <dataDescriptor expression="AIRPORT_LINES.DISTANCE"
           descriptiveExpression="DISTANCE" order="5" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ARRIVED_TIME" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Arrived Time">
          <dataDescriptor expression="AIRPORT_LINES.ARRIVED_TIME"
           descriptiveExpression="ARRIVED_TIME" order="6" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="FLY_TIME" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Fly Time">
          <dataDescriptor expression="AIRPORT_LINES.FLY_TIME"
           descriptiveExpression="FLY_TIME" order="7" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="STATUS_CODE" oracleDatatype="number" columnOrder="18"
         width="22" defaultWidth="40000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Status Code">
          <dataDescriptor expression="AIRPORT_LINES.STATUS_CODE"
           descriptiveExpression="STATUS_CODE" order="8" width="22"
           precision="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PLANE_CODE" datatype="vchar2" columnOrder="19"
         ...
         defaultLabel="Plane Code">
          <dataDescriptor expression="AIRPORT_LINES.PLANE_CODE"
           descriptiveExpression="PLANE_CODE" order="9" width="7"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="FROM_AIRPORT_ID" datatype="vchar2" columnOrder="20"
         ...
         defaultLabel="From Airport Id">
          <dataDescriptor expression="AIRPORT_LINES.FROM_AIRPORT_ID"
           descriptiveExpression="FROM_AIRPORT_ID" order="10" width="3"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TO_AIRPORT_ID" datatype="vchar2" columnOrder="21"
         width="3" defaultWidth="30000" defaultHeight="10000" columnFlags="33"
         defaultLabel="To Airport Id">
          <dataDescriptor expression="AIRPORT_LINES.TO_AIRPORT_ID"
           descriptiveExpression="TO_AIRPORT_ID" order="11" width="3"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
  ...
  <section name="main">
    <body>
      <frame name="M_G_FLIGHT_NUMBER_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="7.50000" height="0.43750"
        />
        ...
        <repeatingFrame name="R_G_FLIGHT_NUMBER" source="G_FLIGHT_NUMBER"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.25000" width="7.50000"
           height="0.18750"/>
          ...
          <field name="F_FLIGHT_NUMBER" source="FLIGHT_NUMBER"
           minWidowLines="1" spacing="0" alignment="start">
            ...
            <geometryInfo x="0.00000" y="0.25000" width="1.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_FIRST_CLASS" source="FIRST_CLASS" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="1.31250" y="0.25000" width="0.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_BUSINESS_CLASS" source="BUSINESS_CLASS"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="1.87500" y="0.25000" width="0.75000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_ECONOMY_CLASS" source="ECONOMY_CLASS"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="2.62500" y="0.25000" width="0.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_DISTANCE" source="DISTANCE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="3.18750" y="0.25000" width="0.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_ARRIVED_TIME" source="ARRIVED_TIME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="3.68750" y="0.25000" width="1.00000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_FLY_TIME" source="FLY_TIME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="4.68750" y="0.25000" width="1.00000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_STATUS_CODE" source="STATUS_CODE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="5.68750" y="0.25000" width="0.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_PLANE_CODE" source="PLANE_CODE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="6.12500" y="0.25000" width="0.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_FROM_AIRPORT_ID" source="FROM_AIRPORT_ID"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="6.50000" y="0.25000" width="0.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_TO_AIRPORT_ID" source="TO_AIRPORT_ID"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="7.00000" y="0.25000" width="0.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_FLIGHT_NUMBER_HDR">
          ...
          <text name="B_FLIGHT_NUMBER" minWidowLines="1">
            ...
            <geometryInfo x="0.00000" y="0.00000" width="1.31250"
             height="0.12500"/>
          ...
          <text name="B_FIRST_CLASS" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.31250" y="0.00000" width="0.56250"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_BUSINESS_CLASS" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.87500" y="0.00000" width="0.75000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_ECONOMY_CLASS" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.62500" y="0.00000" width="0.56250"
             height="0.25000"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_ARRIVED_TIME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.68750" y="0.00000" width="1.00000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_FLY_TIME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.68750" y="0.00000" width="1.00000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_STATUS_CODE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.68750" y="0.00000" width="0.43750"
             height="0.25000"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_PLANE_CODE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.12500" y="0.00000" width="0.37500"
             height="0.25000"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_TO_AIRPORT_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="7.00000" y="0.00000" width="0.50000"
             height="0.25000"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
...
<rw:dataArea id="MGFLIGHTNUMBERGRPFR135">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBFLIGHTNUMBER135" asArray="no"/> class="OraColumnHeader"> Flight Number </th>
   <th <rw:id id="HBFIRSTCLASS135" asArray="no"/> class="OraColumnHeader"> First Class </th>
   <th <rw:id id="HBBUSINESSCLASS135" asArray="no"/> class="OraColumnHeader"> Business Class </th>
   <th <rw:id id="HBECONOMYCLASS135" asArray="no"/> class="OraColumnHeader"> Economy
Class </th>
   <th <rw:id id="HBDISTANCE135" asArray="no"/> class="OraColumnHeader"> Distance </th>
   <th <rw:id id="HBARRIVEDTIME135" asArray="no"/> class="OraColumnHeader"> Arrived Time </th>
   <th <rw:id id="HBFLYTIME135" asArray="no"/> class="OraColumnHeader"> Fly Time </th>
   <th <rw:id id="HBSTATUSCODE135" asArray="no"/> class="OraColumnHeader"> Status
Code </th>
   <th <rw:id id="HBPLANECODE135" asArray="no"/> class="OraColumnHeader"> Plane
Code </th>
   <th <rw:id id="HBFROMAIRPORTID135" asArray="no"/> class="OraColumnHeader"> From
Airport Id </th>
   <th <rw:id id="HBTOAIRPORTID135" asArray="no"/> class="OraColumnHeader"> To
Airport Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGFLIGHTNUMBER1351" src="G_FLIGHT_NUMBER">
   <tr>
    <td <rw:headers id="HFFLIGHTNUMBER135" src="HBFLIGHTNUMBER135"/> class="OraCellNumber"><rw:field id="FFLIGHTNUMBER135" src="FLIGHT_NUMBER" nullValue="&nbsp;"> F_FLIGHT_NUMBER </rw:field></td>
    <td <rw:headers id="HFFIRSTCLASS135" src="HBFIRSTCLASS135"/> class="OraCellNumber"><rw:field id="FFIRSTCLASS135" src="FIRST_CLASS" nullValue="&nbsp;"> F_FIRST_CLASS </rw:field></td>
    <td <rw:headers id="HFBUSINESSCLASS135" src="HBBUSINESSCLASS135"/> class="OraCellNumber"><rw:field id="FBUSINESSCLASS135" src="BUSINESS_CLASS" nullValue="&nbsp;"> F_BUSINESS_CLASS </rw:field></td>
    <td <rw:headers id="HFECONOMYCLASS135" src="HBECONOMYCLASS135"/> class="OraCellNumber"><rw:field id="FECONOMYCLASS135" src="ECONOMY_CLASS" nullValue="&nbsp;"> F_ECONOMY_CLASS </rw:field></td>
    <td <rw:headers id="HFDISTANCE135" src="HBDISTANCE135"/> class="OraCellText"><rw:field id="FDISTANCE135" src="DISTANCE" nullValue="&nbsp;"> F_DISTANCE </rw:field></td>
    <td <rw:headers id="HFARRIVEDTIME135" src="HBARRIVEDTIME135"/> class="OraCellText"><rw:field id="FARRIVEDTIME135" src="ARRIVED_TIME" nullValue="&nbsp;"> F_ARRIVED_TIME </rw:field></td>
    <td <rw:headers id="HFFLYTIME135" src="HBFLYTIME135"/> class="OraCellText"><rw:field id="FFLYTIME135" src="FLY_TIME" nullValue="&nbsp;"> F_FLY_TIME </rw:field></td>
    <td <rw:headers id="HFSTATUSCODE135" src="HBSTATUSCODE135"/> class="OraCellNumber"><rw:field id="FSTATUSCODE135" src="STATUS_CODE" nullValue="&nbsp;"> F_STATUS_CODE </rw:field></td>
    <td <rw:headers id="HFPLANECODE135" src="HBPLANECODE135"/> class="OraCellText"><rw:field id="FPLANECODE135" src="PLANE_CODE" nullValue="&nbsp;"> F_PLANE_CODE </rw:field></td>
    <td <rw:headers id="HFFROMAIRPORTID135" src="HBFROMAIRPORTID135"/> class="OraCellText"><rw:field id="FFROMAIRPORTID135" src="FROM_AIRPORT_ID" nullValue="&nbsp;"> F_FROM_AIRPORT_ID </rw:field></td>
    <td <rw:headers id="HFTOAIRPORTID135" src="HBTOAIRPORTID135"/> class="OraCellText"><rw:field id="FTOAIRPORTID135" src="TO_AIRPORT_ID" nullValue="&nbsp;"> F_TO_AIRPORT_ID </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
